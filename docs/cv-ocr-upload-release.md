...
> Latest code batch: [v77 anchored employer tenures](precision-anchored-employer-batch-20260916.md). All 970 sources compared: 18 additional records recovered, 33 net additional rows, two footer-contaminated titles corrected; 466 sources remain unresolved locally. Diagnostic counts are unchanged. This batch performs no additional production data write.
