...
> Latest code batch: [v83 career ledger recovery](precision-career-ledger-batch-20260916.md). The complete read-only 970-source comparison reaches 674 sources / 1,939 employment rows, leaving 296 sources for source review. All 1,857 v82 tuples are retained; malformed, duplicate and invalid-range counts remain zero, and client/employer equality remains two. This is code and private audit evidence only: the v83 results have not been backfilled, live OCR has not been verified, and exact-artifact authenticated acceptance remains outstanding.
