-- STAGING AUTH HELPERS ROLLBACK v4 - REVIEW ONLY - NOT EXECUTED
-- STAGING ONLY. Run after RLS/bootstrap rollback. Backup and explicit human approval required. PRODUCTION BLOCKED.
begin;
