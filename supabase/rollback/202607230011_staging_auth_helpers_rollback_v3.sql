-- STAGING AUTH HELPERS ROLLBACK v3 - REVIEW ONLY - NOT EXECUTED
-- STAGING ONLY. Run after RLS and bootstrap rollback where applicable. Backup and explicit human approval required.
begin;
...
commit;
-- No table, candidate-domain object, Auth user, or production object is touched.
