...
assert.match(drawer, /candidateProfileTabLabel\(/);
assert.match(drawer, /item as CandidateProfileTab/);
assert.match(drawer, /candidate\.talentPool === "linkedin_talent_pool"/);
