...
const labelledProjectCareer = "PROFESSIONAL EXPERIENCE PROJECT 1 Client: Buyer One Company: Example Services Ltd Project: SAP upgrade Duration: Mar 2014 to Sep 2014 Role: SAP FICO Consultant Client Description Buyer. PROJECT 2: Client: Buyer Two Company: Example Advice Ltd Project: Implementation Project Duration: May 2013 - Feb2014 Role: Junior SAP FI Consultant Description: Delivered upgrade.";
assert.deepEqual(ownedProjectCareerLedger(labelledProjectCareer).map(({employer,client,role,start,end})=>({employer,client,role,start,end})), [
  {employer:"Example Services Ltd",client:"Buyer One",role:"SAP FICO Consultant",start:"Mar 2014",end:"Sep 2014"},
  {employer:"Example Advice Ltd",client:"Buyer Two",role:"Junior SAP FI Consultant",start:"May 2013",end:"Feb 2014"},
]);
const projectOnlyClient = "PROFESSIONAL EXPERIENCE PROJECT 1 Client: Buyer One Company: Buyer One Project: Upgrade Duration: Mar 2014 to Apr 2014 Role: SAP Consultant Description: customer only. PROJECT 2 Client: Buyer Two Company: Example Services Ltd Project: Rollout Duration: Dec 2015 to Jan 2015 Role: SAP Consultant Description: reversed date. PROJECT 3 Client: Buyer Three Company: Example Services Ltd Project: Rollout Duration: Jan 2016 to Feb 2016 Description: missing role. PROJECT 4 Client: Buyer Four Company: Example Services Ltd Project: Support Duration: Mar 2016 to till date Role: SAP Consultant Description: undated CV does not establish a present-day assignment.";
assert.deepEqual(ownedProjectCareerLedger(projectOnlyClient), [], "clients, reversed dates and fields borrowed from the next card cannot create employer records");
