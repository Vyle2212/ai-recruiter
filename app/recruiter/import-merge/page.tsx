...
export default function ImportMergePage() {
  ...
  useEffect(() => {
    ...
    }).catch((reason) => { if (reason?.name !== "AbortError") setError(reason instanceof Error ? reason.message : "Unable to load proposals"); });
