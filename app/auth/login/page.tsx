      ...
      <AuthHeader
        ...
        subtitle={
          acceptance
            ...
            : "Approved Supabase authentication for the staging environment."
        }
      />
        ...
        <section className={card}>
          <div className="flex flex-wrap gap-2 text-xs">
            <span className="rounded-full border border-cyan-500/40 px-3 py-1 text-cyan-200">
              {acceptance ? "Acceptance only" : "Staging only"}
            </span>
          ...
          <p className="mt-4 text-sm text-slate-400">
            Successful authentication redirects to the portal assigned to the
            active profile role.
          </p>
        </section>
        ...
        {!acceptance && (
          <section className={card}>
            <div className="flex flex-wrap gap-4 text-sm text-cyan-300">
              <Link href="/auth/staging/runtime">Open runtime diagnostics</Link>
